...
class ParabolicSARStrategy(Strategy):
    ...
    def generate_signals(self):
        ...
        # Set initial values
        sar[0] = copy_data['low'][0] if copy_data['close'][0] > copy_data['open'][0] else copy_data['high'][0]
        ep[0] = copy_data['high'][0] if copy_data['close'][0] > copy_data['open'][0] else copy_data['low'][0]
